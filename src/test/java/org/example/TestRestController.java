...
public class TestRestController {
    ...
    @Test
    void AutoTestAccountController_AccountNotFound() throws Exception {
        ...
        request = """
                ...
                """;
        this.mockMvc.perform(post(strURL)
...
//                        content().contentTypeCompatibleWith(MediaType.TEXT_PLAIN),
                        content().json("{\n" +
                                ...
                                "        \"accountId\": null\n" +
                                "    },\n" +
                                "    \"errorMsg\": \"По instanceId \\\"Идентификатор ЭП\\\" <-1> не найден экземпляр продукта.\"\n" +
                                "}")
                );
    }

    @Test
    void AutoTestAccountController_Found() throws Exception {
        String strURL = "/corporate-settlement-account/create/";
        String request;
