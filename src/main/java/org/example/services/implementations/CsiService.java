...
//•	сформировать agreement.Id , связать с таблицей ЭП по ИД ЭП, где tpp_product.id  == agreement.product_id
                ...
                if (agreement.getShedulerJobId() != null)
                ...
                if (agreement.getValidityDuration() != null)
                ...
                if (agreement.getCoefficient() != null)
                ...
                if (agreement.getMinimumInterestRate() != null)
                    agreementsEntity.setMinimumInterestRate(BigDecimal.valueOf(agreement.getMinimumInterestRate()));
                if (agreement.getMinimumInterestRateCoefficient() != null)
